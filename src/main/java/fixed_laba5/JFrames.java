...
public class JFrames extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2 = new BackgroundPanel(game.getFight().getCurrentLocation().locationThemePath);
        ...
        Human human = game.NewHuman(playerHPProgressBar);
        ...
        weakBtn.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        attackBtn.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        defendBtn.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        enemyPicture.setVerticalAlignment(javax.swing.SwingConstants.CENTER);
        enemyPicture.setPreferredSize(new Dimension(128, 276));
        enemyPicture.setSize(128, 276);
        ...
        enemyDamageLabel.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        enemyDamageLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        damageLabel.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        damageLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        damageCountLabel.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        ...
        enemyDamageCount.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        ...
        fightLabel.setFont(new java.awt.Font("Monospaced", 3, 36)); // NOI18N
        fightLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        hpPoints.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        hpPoints.setForeground(new java.awt.Color(255, 255, 0));
        ...
        enemyHPPoints.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        enemyHPPoints.setForeground(new java.awt.Color(255, 255, 0));
        ...
        experienceLabel.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        experienceLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        pointsLabel.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        ...
        expCountLabel.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        expCountLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        pointCountLabe.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        pointCountLabe.setForeground(new java.awt.Color(255, 255, 0));
        ...
        enemyLevel.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        enemyLevel.setForeground(new java.awt.Color(255, 255, 0));
        enemyLevel.setText("1 уровень");
        jPanel2.add(enemyLevel, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 229, -1, -1));

        effectLabel.setFont(new java.awt.Font("Monospaced", 0, 16)); // NOI18N
        effectLabel.setForeground(new java.awt.Color(255, 255, 0));
        ...
        informationLabel.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        playerName.setFont(new java.awt.Font("Monospaced", 2, 14)); // NOI18N
        ...
        jLabel29.setFont(new java.awt.Font("Monospaced", 0, 16)); // NOI18N
        ...
        itemsBtn.setBackground(new java.awt.Color(255, 255, 0));
        itemsBtn.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        locationLable.setForeground(new java.awt.Color(255, 255, 0));
        ...
        jLabel18.setFont(new java.awt.Font("Monospaced", 1, 42)); // NOI18N
        ...
        jLabel24.setFont(new java.awt.Font("Monospaced", 3, 24)); // NOI18N
        ...
        jLabel30.setFont(new java.awt.Font("Monospaced", 0, 16)); // NOI18N
        ...
        jRadioButton3.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        ...
        jLabel31.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        ...
        jButton11.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
...
//        jPanel2.setBackgroundImage(game.getFight().getCurrentLocation().locationThemePath);
//        locationLable.setText("Локация №"+game.getFight().getCurrentLocationsCount());
    ...
    protected BackgroundPanel jPanel2;
