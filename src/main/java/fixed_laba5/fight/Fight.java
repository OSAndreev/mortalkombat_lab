...
public class Fight {
    ...
    public Fight(){
        locationList.add(new GrorsLair());
        locationList.add(new PalaceGates());
        locationList.add(new ThePit());
        locationList.add(new ThePitBottom());
        locationList.add(new WarriorShare());
    }
    ...
    public void EndFinalRound(Human human, CharacterAction action,
        ...
        frame.dispose();
        System.out.println("win: " + human.getWin());
    ...
    public Location getCurrentLocation(){
        return locationList.get(currentLocationsCount % locationList.size());
    }
